      ...
      <div className="three_section_parent_div">
        ...
        <div className="three_section_child_div">
          ...
          <div>
            ...
            <p className="three_section_p">
              • To acknowledge & transform reoccurring behaviors & reactions
              into proactive, positive responses
            </p>
            <p className="three_section_p">
        ...
        <div className="your_support_div">
          <p className="three_section_p">
            ...
            <Link className="tiffany_email">
              tiffany@youremotionsmatter.com
            </Link>
            , via social media or book a one on one by clicking here to share
            your challenges & frustrations so I may customize your plan
            utilizing my “Why You Matter Playbook.”
          </p>
