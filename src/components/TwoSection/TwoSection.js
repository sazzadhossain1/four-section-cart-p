    ...
    <div className="two_section_parent_div">
      <div className="two_section_child_div">
        ...
        <p>
          ...
          your finances, your relationships, & including but not limited to life
          transitions, you must learn Emotional Intelligence. Emotional
        ...
        <p>
          ...
          aware. Imagine approaching personal challenges with confidence, ease,
          & a plan!
        </p>
      </div>
    </div>
